...
for i in range(n):
    ...
    crd_t.append(cr)
    ms.append(cr)
    ms.append(int(input(f"Enter the average mid sem marks of the {sub[i]}: ")))
    ms.append(int(input(f"Enter the quiz assignment and prof marks combined of the {sub[i]}: ")))
    ms.append(int(input(f"Enter the expected end sem marks of the {sub[i]}: ")))
    theory.append(ms)
...
for i in range(m):
    ...
    crd_l.append(cd)
    lab_marks.append(cd)
    lab_marks.append(int(input(f"Enter the expected viva marks of {lab_s[i]}: ")))
    lab_marks.append(int(input(f"Enter the expected sbmp marks of {lab_s[i]}: ")))
    lab_marks.append(int(input(f"Enter the expected lab file marks of {lab_s[i]}: ")))
